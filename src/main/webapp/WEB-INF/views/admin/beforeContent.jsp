...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" type="image/x-icon"
			href="https://adminlte.io/themes/v3/dist/img/AdminLTELogo.png">
		...
		<link rel="stylesheet"
			href="https://adminlte.io/themes/v3/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
		
		<link rel="stylesheet"
			href="https://adminlte.io/themes/v3/plugins/jqvmap/jqvmap.min.css">
		...
		<link rel="stylesheet"
			href="https://adminlte.io/themes/v3/plugins/summernote/summernote-bs4.min.css">
			...
			<nav
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item d-none d-sm-inline-block"><a
						href="/admin/dashboard" class="nav-link">Home</a></li>
