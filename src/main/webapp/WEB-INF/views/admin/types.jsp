...
<div class="content-wrapper">
	...
	<div class="form w-25 mx-auto" id="popupbox">
		<div class="card card-warning">
			<div class="card-header">
				<h3 class="card-title">Add Types</h3>
			...
			<!-- /.card-header -->
			<div class="card-body">
				<form:form action="type/add" method="post"
	...
	<div class="row m-3">
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">Type Data</h3>

					<div class="card-tools">
						<div class="form-group d-inline-flex m-auto">
							<button type="button" class="btn btn-sm btn-primary"
								onclick="javascript:login('show');">Add Type</button>
						</div>
						...
						<tbody>
							...
							<c:forEach items="${types }" var="i">
								<tr>
									...
									<td><a class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to visit this site?');" href="type/delete?id=${i.id }"><i class="fa fa-trash" ></i></a>
									<a class="btn btn-sm btn-warning" href="type/edit?id=${i.id }"><i class="fa fa-edit" ></i></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
