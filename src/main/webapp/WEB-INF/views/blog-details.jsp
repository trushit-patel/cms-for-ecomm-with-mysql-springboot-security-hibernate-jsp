                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="blog-left-sidebar.html">blogs</a></li>
                        ...
                        <div class="blog-item-wrapper">
                            ...
                            <div class="blog-post-item blog-details-post">
                                <figure class="blog-thumb">
                                    <img src="/blog-photos/${blog.id }/${blog.image}" alt="blog image">
                                </figure>
                                <div class="blog-content">
                                    ...
                                    <div class="blog-meta">
                                        <p>${blog.postedOn } | <a href="#">${blog.postedBy }</a></p>
                                    </div>
