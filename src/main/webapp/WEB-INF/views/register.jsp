												...
												<ul class="dropdown">
													<li><a href="#">shop grid layout <i
														...
														<ul class="dropdown">
															...
															<li><a href="shop-grid-right-sidebar.html">shop
																	grid right sidebar</a></li>
															<li><a href="shop-grid-full-3-col.html">shop
																	grid full 3 col</a></li>
															<li><a href="shop-grid-full-4-col.html">shop
																	grid full 4 col</a></li>
														</ul></li>
											...
											<li><a href="blog-left-sidebar.html">Blog <i
												...
												<ul class="dropdown">
													...
													<li><a href="blog-list-right-sidebar.html">blog
															list right sidebar</a></li>
													<li><a href="blog-grid-full-width.html">blog grid
															full width</a></li>
													...
													<li><a href="blog-details-video.html">blog details
															video</a></li>
													<li><a href="blog-details-image.html">blog details
															image</a></li>
												</ul></li>
											<li><a href="contact-us.html">Contact us</a></li>
										</ul>
						...
						<div class="mobile-main-header">
							...
							<div class="mobile-menu-toggler">
								<div class="mini-cart-wrap">
									<a href="cart.html"> <i class="pe-7s-shopbag"></i>
										<div class="notification">0</div>
									</a>
								</div>
							...
							<li>
								<div class="dropdown mobile-top-dropdown">
									<a href="#" class="dropdown-toggle" id="currency"
										...
										aria-expanded="false"> Currency <i
										class="fa fa-angle-down"></i>
									</a>
									...
									<div class="single-input-item">
										<spring:bind path="gender">
											<div class="form-group ${status.error ? 'has-error' : ''}">
												...
												<label class="w-100">Male:<form:radiobutton path="gender" placeholder="Gender"
													value="Male" class="w-25"/></label>
													<label class="w-100">Female:<form:radiobutton path="gender" placeholder="Gender"
													value="Female" class="w-25"/></label>
										...
										<spring:bind path="number">
											<div class="form-group ${status.error ? 'has-error' : ''}">
												<form:input type="text" path="number" class="form-control"
													placeholder="Number" autofocus="true"></form:input>
